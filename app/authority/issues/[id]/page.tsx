...
import { ArrowLeft, MapPin, Calendar, User, Volume2 } from "lucide-react"
...
export default async function AuthorityIssueDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Update the status of this issue</p>
        </div>
      </div>
      ...
      {typedIssue.status !== "resolved" && (
        <Card>
          ...
          <CardContent>
            <UpdateStatusForm issueId={typedIssue.id} currentStatus={typedIssue.status} />
          </CardContent>
        </Card>
      )}
